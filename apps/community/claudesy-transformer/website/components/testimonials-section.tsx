...
export default function TestimonialsSection() {
  ...
  const testimonials = [
    {
      quote:
        "CTE V2 merevolusi cara tim kami merekayasa prompt dalam skala besar. Pendekatan meta-prompting yang dikombinasikan dengan injeksi strategi memastikan output Artificial Intelligence kami selalu terstruktur dan dapat diprediksi. Ini seperti memiliki ahli rekayasa prompt yang tertanam di setiap request.",
      name: "Dr. Rizky Pratama",
      company: "Lead Artificial Intelligence Architect, Sentra Digital Labs",
      image:
    ...
    {
      quote:
        "Sejak pakai CTE V2, waktu iterasi prompt kami turun drastis. Apa yang dulu butuh berjam-jam kini selesai dalam hitungan detik dengan kualitas output yang jauh lebih konsisten. Mode Technical-nya sangat membantu untuk dokumentasi API dan debugging.",
      name: "Anindya Kusuma",
      company: "Principal Engineer, Gojek Developer Platform",
      image:
    ...
    {
      quote:
        "Sebagai content creator, CTE V2 adalah game changer. Mode Creative dan Academic-nya menghasilkan prompt yang jauh lebih tajam dari yang bisa saya tulis sendiri. Output dari Claude 4 dan GPT-5 jadi konsisten dan berkualitas tinggi di setiap sesi.",
      name: "Salsabila Nuraini",
      company: "Senior Content Strategist, Tokopedia Creative Studio",
      image:
