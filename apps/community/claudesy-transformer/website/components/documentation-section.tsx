...
export default function DocumentationSection() {
  ...
  const cards = [
    {
      title: "Input Prompt Mentah",
      description: "Tulis ide asar Anda apa adanya. Tidak perlu prompt engineering manual — cukup jelaskan tujuan, tipe tugas, nada, dan model Artificial Intelligence target yang ingin digunakan.",
      image: "/modern-dashboard-interface-with-data-visualization.jpg",
    },
    {
      title: "Pilih Model & Mode Transformasi",
      description: "Pilih salah satu dari 7 provider Artificial Intelligence (OpenAI, Anthropic, Gemini, dan lainnya) serta 5 mode transformasi: Professional, Creative, Technical, Academic, atau Casual.",
      image: "/analytics-dashboard.png",
    },
    {
      title: "Dapatkan SuperPrompt Siap Pakai",
      description: "CTE V2 menghasilkan SuperPrompt terstruktur lengkap dengan blok Role, Context, Task, Constraints, dan Output Format — langsung optimal untuk model Artificial Intelligence pilihan Anda.",
      ...
      <div className="self-stretch px-6 md:px-24 py-12 md:py-16 border-b border-[rgba(55,50,47,0.12)] flex justify-center items-center gap-6">
        <div className="w-full max-w-[586px] px-6 py-5 shadow-[0px_2px_4px_rgba(50,45,43,0.06)] overflow-hidden rounded-lg flex flex-col justify-start items-center gap-4 shadow-none">
          <Badge
            ...
            text="Bagaimana CTE2 Bekerja"
          />
          <div className="self-stretch text-center flex justify-center flex-col text-[#49423D] text-3xl md:text-5xl font-semibold leading-tight md:leading-[60px] font-sans tracking-tight">
            Pipeline transformasi
          </div>
          <div className="self-stretch text-center text-[#605A57] text-base font-normal leading-7 font-sans">
            Dari instruksi mentah hingga SuperPrompt yang fully optimized untuk model Artificial Intelligence pilihan Anda
            <br />
            — hanya dalam tiga langkah otomatis.
          </div>
        </div>
      </div>
