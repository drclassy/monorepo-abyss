  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* Google DeepMind — Middle ring 315° (top-right) */}
        <div
          style={{
            width: "32px",
            height: "32px",
        ...
        {/* Meta — Middle ring 135° (bottom-left) */}
        <div
          style={{
            width: "32px",
            height: "32px",
        ...
        {/* xAI — Middle ring 225° (bottom-left diagonal) */}
        <div
          style={{
            width: "32px",
            height: "32px",
        ...
        {/* Moonshot Kimi K2 — Outer ring 0° (right) */}
        <div
          style={{
            width: "32px",
            height: "32px",
