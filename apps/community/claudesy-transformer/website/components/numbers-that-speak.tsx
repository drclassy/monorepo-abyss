...
const NumbersThatSpeak: React.FC<NumbersThatSpeakProps> = ({
  ...
  return (
    <div
      ...
      role="img"
      aria-label="Dashboard SuperPrompt menampilkan statistik penggunaan CTE V2"
                          ...
                          >
                            ...
                            >
                              ...
                              >
                                ...
                                >
                                  {["50k", "30k", "20k", "10k", "0"].map((label, index) => (
                                    <div
                                      key={index}
                                      style={{
                                        display: "flex",
                              ...
                              >
                                ...
                                >
                                  <div style={{ whiteSpace: "pre" }}>Mar 2025</div>
                                  <div style={{ whiteSpace: "pre" }}>Mar 2026</div>
                                </div>
                              </div>
                            </div>
                          </div>
