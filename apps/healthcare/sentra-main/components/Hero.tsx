...
export default function Hero() {
  const pilotLoginHref =
    process.env.NEXT_PUBLIC_PILOT_LOGIN_URL?.trim() || '/dashboard'
          ...
          <div className="flex flex-col gap-12">
            ...
            <div className="flex flex-col gap-6">
              ...
              >
                ...
                <span className="sr-only">
                  COMING SOON 2026 — Clinical Decision Support berbasis AI untuk Layanan Kesehatan Indonesia
                </span>
            ...
            >
              ...
              >
                ...
                <ArrowUpRight size={16} className="text-accent/70 group-hover:text-accent transition-colors" />
              </Link>
            </motion.div>
          </div>
