...
│   ├── hero.jpg / hero2.jpg    Hero section backgrounds
│   └── fit1–fit9.png           Gallery/showcase images
│
├── scripts/
...
5. Add brand signature: `// Architected and built by Claudesy.`
...
- **Brand signature**: Every new file must include `// Architected and built by Claudesy.` on the first or second line
