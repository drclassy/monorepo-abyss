...
`public/google22238cc24e0d1002.html` is a domain verification file. It does not collect user data — it only confirms to Google that Sentra controls this domain.
