...
function TrainingHeader() {
  return (
    <>
      ...
      <div className="fi-term-line-output">
        Train: <span className="fi-term-c-accent">36,184</span> | Val:{' '}
        <span className="fi-term-c-python">4,523</span> | Test:{' '}
        <span className="fi-term-c-data">4,524</span>
      </div>
      <div className="fi-term-line-output">
        <span className="fi-term-c-data">
