      ...
      <main className="fi-news-shell" id="main-content">
        ...
        <div className="fi-news-main">
          <header className="fi-news-hero" id="classy-news-foreword">
            <div className="fi-news-hero-copy">
            ...
            <aside className="fi-news-hero-aside" aria-label="Catatan pembuka redaksi">
          ...
          >
            <article className="fi-news-lead-story">
              <a
            ...
            <div className="fi-news-secondary-column" aria-label="Secondary stories">
              {classyNewsSecondaryStories.map((story, index) => (
                <article className="fi-news-secondary-story" key={story.headline}>
                  <a
          ...
          >
            <div className="fi-news-section-head fi-news-section-head-on-dark">
            ...
            <div className="fi-news-trending-grid">
              {classyNewsTrendingStories.map((story) => (
                <article className="fi-news-trending-card" key={story.headline}>
                  <a
                    className="fi-news-card-link"
                    href={story.href}
                    rel="noreferrer"
          ...
          >
            ...
            <div className="fi-news-depth-grid">
              {classyNewsFeatureStories.map((story) => (
                <article className="fi-news-depth-card" key={story.headline}>
                  <a
                    className="fi-news-card-link"
                    href={story.href}
                    rel="noreferrer"
          ...
          >
            <div className="fi-news-editorial-intro">
            ...
            <div className="fi-news-editorial-list">
              {classyNewsEditorPicks.slice(0, 3).map((story) => (
                <article className="fi-news-editorial-card" key={story.headline}>
                  <a
                    className="fi-news-card-link"
                    href={story.href}
                    rel="noreferrer"
          ...
          >
            ...
            <div className="fi-news-bridge-grid">
              {classyNewsBridgeCards.map((card) => (
                <article className="fi-news-bridge-card" key={card.label}>
          ...
          >
            <div className="fi-news-closing-copy">
            ...
            <div className="fi-news-closing-actions">
