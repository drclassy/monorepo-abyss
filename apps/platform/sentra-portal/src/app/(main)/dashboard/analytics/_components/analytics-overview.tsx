...
const riskViews: Array<{
  ...
  {
    value: "risk-view",
    label: "Orchestrator Overview",
    description: "Saga engine health",
  },
  {
    value: "momentum",
    label: "Flow Momentum",
  ...
  },
  {
    ...
    description: "Model accuracy logs",
  },
];
  ...
  return (
    <div className="grid grid-cols-1 gap-4 lg:grid-cols-3">
      <div className="space-y-2">
        <div>
          <div className="font-medium text-muted-foreground text-sm">AI Executions</div>
          <div className="font-semibold text-4xl tabular-nums tracking-tight">12,480</div>
        </div>
        <div className="flex flex-wrap items-center gap-2">
          <Badge variant="secondary">+14.2%</Badge>
          <Badge variant="secondary">+1,550 ops</Badge>
        </div>

        <div className="flex flex-wrap items-center gap-2 text-muted-foreground text-sm">
          <span>Previous 10,930</span>
      ...
      <Card className="py-4 shadow-xs lg:col-span-2">
        <CardHeader className="px-4">
          <CardTitle>Orchestrator Metrics</CardTitle>
          <CardDescription>Core performance signals for Abyss Saga Engine</CardDescription>
        </CardHeader>
