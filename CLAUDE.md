...
You are operating inside The Abyss — an AI-native Turborepo monorepo owned by Dr. Ferdi Iskandar (Claudesy). This file is your entry point. AGENTS.md is the supreme authority. When this file conflicts with AGENTS.md, AGENTS.md wins.

---

## GUARD 1: Mandatory Context Initialization

CRITICAL: Read the entire `.agent/` folder before performing any task. Assume context window resets at any moment. All state lives in `.agent/`.
...
Every non-trivial task follows JET, but depth depends on Task Classification (AGENTS.md §2.1).
