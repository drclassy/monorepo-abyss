import { Brain, Server, ShieldCheck, Zap, UserCheck } from 'lucide-react'
      ...
      <div className="space-y-4">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          <div className="bg-white dark:bg-[#0F0F12] rounded-xl p-6 border-2 border-purple-500/20 dark:border-purple-500/30">
            ...
            <p className="text-2xl font-bold mt-2 text-purple-500 uppercase tracking-tight">
              Deploying v1.4
            </p>
          </div>
          <div className="bg-white dark:bg-[#0F0F12] rounded-xl p-6 border border-gray-200 dark:border-[#1F1F23]">
            ...
            <p className="text-2xl font-bold mt-2 text-emerald-500 uppercase tracking-tight">
              Vigilant
            </p>
          </div>
          <div className="bg-white dark:bg-[#0F0F12] rounded-xl p-6 border border-gray-200 dark:border-[#1F1F23]">
            ...
            <p className="text-2xl font-bold mt-2 text-blue-500 uppercase tracking-tight">
              System Guarded
            </p>
          </div>
        </div>
          ...
          <div className="bg-white dark:bg-[#0F0F12] rounded-xl p-6 border border-gray-200 dark:border-[#1F1F23]">
            ...
            <div className="space-y-4">
              {[
                ...
                <div
                  key={i}
                  className="flex items-center justify-between p-3 rounded-lg bg-zinc-50 dark:bg-zinc-800/20 border border-zinc-100 dark:border-zinc-800"
                >
