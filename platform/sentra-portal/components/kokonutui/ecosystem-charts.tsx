...
export default function EcosystemCharts() {
  const SECTION_TITLE =
    'text-[13px] font-medium text-zinc-500 mb-6 text-left flex items-center gap-2 uppercase tracking-[0.25em]'
    ...
    <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 font-sans">
      ...
      <div className="bg-white dark:bg-[#0F0F12] rounded-xl p-6 border border-gray-200 dark:border-[#1F1F23]">
        <div className="flex items-center justify-between mb-6">
          ...
          <span className="text-[9px] font-mono text-zinc-600 bg-zinc-100 dark:bg-zinc-800 px-1.5 py-0.5 rounded border border-rose-500/20">
            PANTONE 18-1664
          </span>
        </div>
      ...
      <div className="bg-white dark:bg-[#0F0F12] rounded-xl p-6 border border-gray-200 dark:border-[#1F1F23]">
        <div className="flex items-center justify-between mb-6">
          ...
          <span className="text-[9px] font-mono text-zinc-600 bg-zinc-100 dark:bg-zinc-800 px-1.5 py-0.5 rounded border border-emerald-500/20">
            PANTONE 2251 C
          </span>
        </div>
        <div className="h-[180px] w-full">
