...
```mermaid
graph TD
    A[Chief dr. Avvcenna+] -- "Memberikan GO" --> B[Jen / Orchestrator]
...
1. **Principal Infrastructure Engineering (DevOps)**
   - **Tugas:** Setup Kafka Cluster dan PostgreSQL Database untuk menyimpan
     `aiSession`.
...
3. **Jen (Sentra Assistant & Orchestrator)**
   - **Tugas:** Merakit logika Saga, Guard, dan integrasi WebSocket ke Sentra
     Portal.
...
_Setiap Nyawa Berharga._ _Generated by Jen for Chief dr. Avvcenna+_
