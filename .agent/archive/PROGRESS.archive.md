...
- **Old remote:** preserved as `origin-classy` → `https://github.com/Classy/abyss-monorepo.git`
...
- **Rollback:** `git remote rename origin-classy origin` restores prior state.
...
- Follow-up non-blocking: rotate classy-memory API keys; audit 3 submodules (sentra-assist, academic-solutions, ferdiiskandar).
...
apps/community/classy-transformer/.gitignore
apps/community/classy-transformer/CLAUDE.md
apps/community/classy-transformer/PROJECT_CONTEXT.md
apps/community/classy-transformer/__tests__/api/auth-abuse-routes.test.ts
apps/community/classy-transformer/__tests__/api/internal-billing-process-expirations.test.ts
apps/community/classy-transformer/__tests__/api/internal-email-process.test.ts
apps/community/classy-transformer/__tests__/api/prompts-idor.test.ts
apps/community/classy-transformer/__tests__/api/prompts-list-create.test.ts
apps/community/classy-transformer/__tests__/api/provider-key-resolution.test.ts
```
...
```
.github/classy-pr-temp.psm1
.github/classy-pr.psm1
...
- **Agent**: Classy
- **Commit**: feat(readme): add Classy character to Classy Workflow section
...
- **Agent**: Classy
- **Commit**: docs(readme): add Classy Genesis Framework v2.4 section
- **Files changed**: 1 file(s)
...
- **Agent**: Classy
- **Commit**: docs(readme): move Genesis Framework below Overview, rename Dr. Ferdi → Dr. Classy
- **Files changed**: 1 file(s)
...
---
## 2026-04-18 02:54 — `cb86b6f` — abyss-core

- **Agent**: Classy
- **Commit**: refactor(cursor): restructure rules to 2026+ best practice modular format
- **Files changed**: 5 file(s)
