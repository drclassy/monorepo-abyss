...
I will help you create a new workflow that follows our stack-agnostic,
...
- **Category**: development, git, testing, debugging, security, documentation,
  deployment, database, ai-tools, or creative
...
Describe WHAT to do, not exact code. Let AI generate appropriate implementation.
...
- Check for existing CSS approach If unclear, ask the user which they prefer.
```

### ❌ DON'T: Provide boilerplate code

```markdown
Create `Button.tsx`: import React from 'react' export const Button = () =>
<button>Click</button>
```
