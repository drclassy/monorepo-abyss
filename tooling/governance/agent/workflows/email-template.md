---
description:
  Create responsive HTML email templates that render correctly across email
  clients
---
      ...
      <tr>
        <td align="center" style="padding: 40px 10px;">
          ...
          >
            ...
            <tr>
              <td
                style="padding: 30px; text-align: center; background-color: #4F46E5;"
              >
                <img
            ...
            <tr>
              <td class="mobile-padding" style="padding: 40px 30px;">
                <h1
                  style="margin: 0 0 20px; font-family: Arial, sans-serif; font-size: 24px; line-height: 30px; color: #1a1a1a;"
                >
                  Your Email Heading
                </h1>
                <p
                  style="margin: 0 0 20px; font-family: Arial, sans-serif; font-size: 16px; line-height: 24px; color: #666666;"
                >
                  This is your email content. Keep it concise and focused on the
                  main message.
                </p>
                  ...
                  <tr>
                    <td style="border-radius: 6px; background-color: #4F46E5;">
                      <a
                        ...
                        target="_blank"
                        style="display: inline-block; padding: 14px 30px; font-family: Arial, sans-serif; font-size: 16px; font-weight: bold; color: #ffffff; text-decoration: none;"
                      >
                        Call to Action
                      </a>
                    </td>
            ...
            <tr>
              <td
                style="padding: 30px; text-align: center; background-color: #f8f8f8; border-top: 1px solid #eeeeee;"
              >
                <p
                  style="margin: 0 0 10px; font-family: Arial, sans-serif; font-size: 12px; color: #999999;"
                >
  ...
  <td style="padding: 0 30px;">
    ...
    >
      <tr>
        ...
        >
          <h3
            style="margin: 0 0 10px; font-family: Arial, sans-serif; font-size: 18px; color: #1a1a1a;"
          >
            Feature One
          </h3>
          <p
...
<tr>
  <td style="padding: 30px;">
    <img
      src="https://via.placeholder.com/540x200"
      alt="Image"
      width="540"
      style="display: block; width: 100%; max-width: 540px; height: auto; border-radius: 4px;"
    />
  </td>
</tr>
```
...
<![endif]-->
<div
  style="background-image: url('https://example.com/bg.jpg'); background-size: cover;"
>
  <!-- Content here -->
</div>
<!--[if mso]>
