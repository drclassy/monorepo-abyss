...
I will help you write effective unit tests that adapt to your project's testing
...
If no testing setup exists, ask user which framework they prefer and help set it
up.
...
**Arrange:** Set up test data and mocks **Act:** Call the function being tested
