...
../../../tooling/governance/validate.ps1

# Or target-specific:
../../../tooling/governance/validate.ps1 -check gitignore
../../../tooling/governance/validate.ps1 -check lockfile
../../../tooling/governance/validate.ps1 -check gitattributes
../../../tooling/governance/validate.ps1 -check eslint
```
