...
**Owner:** Codex/Dexton  
**Primary scope:** `packages/sentra/sentra-nada/src/interop/`  
**Related docs:**  
...
Dokumen ini **tidak** mempromosikan CDS Hooks ke `packages/sentra/sentra-sandi`.
...
- menjaga workflow semantics tetap tinggal di `packages/sentra/sentra-nada`
...
- promosi ke `packages/sentra/sentra-sandi`
...
### What Does Not Move To `packages/sentra/sentra-sandi`
...
- tetapi belum siap dipromosikan ke `packages/sentra/sentra-sandi`
