# `packages/sentra/sentra-sandi` Modernization Spec

**Date:** 2026-04-29  
**Status:** Draft for Chief review  
**Owner:** Codex/Dexton  
**Primary package:** `packages/sentra/sentra-sandi/`  
**Related docs:**  
...
- `docs/specs/aadi-v2/010-2026-04-29-aadi-v2-fhir-promotion-plan.md`  
...
Dokumen ini mendefinisikan bagaimana `packages/sentra/sentra-sandi` harus
...
> menjadikan `packages/sentra/sentra-sandi` sebagai **FHIR validation and normalization package** yang siap menerima promotion bertahap dari interop layer AADI V2.
...
Setelah modernization awal selesai, `packages/sentra/sentra-sandi` seharusnya punya role:
...
`packages/sentra/sentra-sandi` modernization must obey:
...
### What Stays in `packages/sentra/sentra-nada`
...
Any modernization work touching `packages/sentra/sentra-sandi` code must run:
...
> **`packages/sentra/sentra-sandi` should be modernized before it is promoted.**
...
1. `GO` untuk implementation plan `packages/sentra/sentra-sandi modernization`
