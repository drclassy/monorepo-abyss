...
Bangun `AADI V2` di dalam `@sentra/nada` sebagai native diagnostic
...
- `packages/sentra/sentra-nada/src/engine/news2.ts`
- `packages/sentra/sentra-nada/src/engine/vital-alerts.ts`
- `packages/sentra/sentra-nada/src/engine/screening-gates.ts`
- `packages/sentra/sentra-nada/src/engine/symptom-signals.ts`
- `packages/sentra/sentra-nada/src/engine/pattern-engine.ts`
- `packages/sentra/sentra-nada/src/engine/clinical-patterns.ts`
- `packages/sentra/sentra-nada/src/engine/clinical-patterns-definitions.ts`
- `packages/sentra/sentra-nada/src/engine/anaphylaxis.ts`
- `packages/sentra/sentra-nada/src/engine/pe-suspect.ts`
- `packages/sentra/sentra-nada/src/engine/early-warning.ts`
- `packages/sentra/sentra-nada/src/engine/composite-deterioration.ts`
- `packages/sentra/sentra-nada/src/engine/trajectory.ts`
- `packages/sentra/sentra-nada/src/engine/classifiers.ts`
- `packages/sentra/sentra-nada/src/engine/action-protocols.ts`
- `packages/sentra/sentra-nada/src/engine/traffic-light.ts`
- `packages/sentra/sentra-nada/src/engine/hybrid-decisioning.ts`
- `packages/sentra/sentra-nada/src/engine/parity-fixtures.ts`
- `packages/sentra/sentra-nada/src/adapters/assist-patterns-parity.ts`
...
- membangun engine diagnosis baru di luar `packages/sentra/sentra-nada`
...
```text
You are implementing AADI V2 inside @sentra/nada.
