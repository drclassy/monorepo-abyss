...
- Start each guide with lightweight front matter.
- Use sentence case for the title and all headings.
- Keep the first paragraph short and task-oriented.
- Prefer concrete commands, paths, and decision points over long narrative.
