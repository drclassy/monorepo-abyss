...
```txt
docs/tasks/ABYSS-RAG-004_handoff.md
```
...
```txt
Read and execute docs/tasks/ABYSS-RAG-004_handoff.md.
...
Update Proof of Verification in docs/tasks/ABYSS-RAG-004_handoff.md.
```
