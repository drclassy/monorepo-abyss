...
Perluas `packages/fhir-engine` agar dapat memvalidasi secara bounded:
...
- memindahkan mapping authority dari `@the-abyss/symphony`
...
13. `docs/superpowers/plans/2026-04-29-fhir-engine-resource-validation-implementation.md`
...
5. `docs/superpowers/specs/2026-04-29-aadi-v2-fhir-promotion-plan.md`
6. `docs/superpowers/specs/2026-04-29-fhir-engine-modernization-spec.md`
7. `docs/superpowers/plans/2026-04-29-fhir-engine-modernization-implementation.md`
8. `docs/superpowers/plans/2026-04-29-fhir-engine-resource-validation-implementation.md`
...
Yang boleh ditambahkan di `packages/fhir-engine`:
...
- memindahkan authority dari `packages/symphony`
...
```text
You are expanding `packages/fhir-engine` validation support for three deferred FHIR resource families:
- Condition
- RiskAssessment
- DiagnosticReport
...
7. docs/superpowers/specs/README-aadi-v2.md
8. docs/superpowers/specs/2026-04-29-aadi-v2-phase-2-readiness-gate.md
9. docs/superpowers/specs/2026-04-29-aadi-v2-fhir-promotion-plan.md
10. docs/superpowers/specs/2026-04-29-fhir-engine-modernization-spec.md
11. docs/superpowers/plans/2026-04-29-fhir-engine-modernization-implementation.md
12. docs/superpowers/plans/2026-04-29-fhir-engine-resource-validation-implementation.md
...
- Run `pnpm --filter @the-abyss/symphony test` and `typecheck` as part of this lane because package boundary/support matrix changes are in scope.
...
- tetap menjaga `packages/fhir-engine` sebagai bounded validator, bukan FHIR
  platform penuh
