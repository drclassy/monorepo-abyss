...
**Owner:** Codex/Dexton  
**Primary scope:** `packages/symphony/src/interop/`, future `packages/fhir-engine` promotion boundary  
**Related docs:**  
...
- memberi dasar formal sebelum `packages/fhir-engine` dipromosikan
...
Saat ini `packages/symphony/src/interop/symphony-to-fhir.ts` sudah memakai:
...
### Future `packages/fhir-engine` promotion
...
- apakah Phase 2 tetap harden di `packages/symphony/src/interop/`
- atau mulai promosi sebagian ke `packages/fhir-engine`
